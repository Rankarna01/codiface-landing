				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("button", {
							...
							"aria-label": "Menu",
							children: /* @__PURE__ */ jsx("i", { className: "bx bx-menu" })
						})
					]
				})
			]
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		className: "cf-hero",
		children: [/* @__PURE__ */ jsx("div", { className: "cf-hero-bg" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: HERO_CHECKS.map((text) => /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("span", {
							className: "cf-check-icon",
							children: /* @__PURE__ */ jsx("i", { className: "bx bx-check" })
						}), text] }, text))
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("a", {
							...
							href: "#cta",
							children: [/* @__PURE__ */ jsx("i", { className: "bx bx-rocket" }), " Coba Gratis Sekarang"]
						}), /* @__PURE__ */ jsxs("a", {
							className: "cf-btn cf-btn-outline cf-btn-sm",
							href: "#how",
							children: [/* @__PURE__ */ jsx("i", { className: "bx bx-play" }), " Lihat Demo"]
						})]
					}),
					/* @__PURE__ */ jsx("div", {
						...
						children: RATINGS.map((r) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [
										/* @__PURE__ */ jsx("i", { className: "bx bxs-star" }),
										" ",
										r.score
									]
								}), /* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "cf-hero-platform" }),
						/* @__PURE__ */ jsx("img", {
							src: "/images/hero.png",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("i", { className: "bx bx-check" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("b", { children: "Check In" }), /* @__PURE__ */ jsx("span", { children: "09:00 WIB" })] })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "cf-hero-badge-shield",
							children: [/* @__PURE__ */ jsx("i", { className: "bx bx-shield-quarter" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("b", { children: "Aman & Akurat" }), /* @__PURE__ */ jsx("span", { children: "Teknologi AI untuk hasil absensi yang terpercaya" })] })]
						})
					]
				})
			})]
...
function Trusted() {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("p", { children: "Dipercaya oleh perusahaan dari berbagai industri" }), /* @__PURE__ */ jsx("div", {
				className: "cf-marquee",
				children: /* @__PURE__ */ jsx("div", {
					className: "cf-marquee-track",
					children: track.map((p, i) => /* @__PURE__ */ jsxs("span", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: PROBLEMS.map((p) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "ic",
							children: /* @__PURE__ */ jsx("i", { className: `bx ${p.i}` })
						}),
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: SOLUTIONS.map((s) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "ic",
							children: /* @__PURE__ */ jsx("i", { className: `bx ${s.i}` })
						}),
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: FEATURES.map(([i, t, d]) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "ic",
							children: /* @__PURE__ */ jsx("i", { className: `bx ${i}` })
						}),
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "cf-showcase-glow" }), /* @__PURE__ */ jsx("div", {
					...
					children: PLANS.map((p) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", { children: p.features.map((f) => /* @__PURE__ */ jsxs("li", { children: [
								/* @__PURE__ */ jsx("i", { className: "bx bx-check-circle" }),
								" ",
								f
							] }, f)) }),
							/* @__PURE__ */ jsxs("a", {
								...
								children: [
									...
									" ",
									/* @__PURE__ */ jsx("i", { className: "bx bx-right-arrow-alt" })
								]
							})
						]
					}, p.name))
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
					...
					className: i === 2 ? "hl" : "",
					children: typeof cell === "boolean" ? cell ? /* @__PURE__ */ jsx("i", { className: "bx bx-check-circle yes" }) : /* @__PURE__ */ jsx("i", { className: "bx bx-minus no" }) : cell
				}, i)) }, r[0])) })]
			})
		})]
	}) });
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("i", { className: "bx bx-search" }), /* @__PURE__ */ jsx("input", {
						value: q,
					...
					children: [/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: t }), /* @__PURE__ */ jsx("i", { className: "bx bx-plus" })]
					}), /* @__PURE__ */ jsx("div", {
						className: "cf-faq-a",
						children: /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx("i", { className: "bx bx-star" }), " Siap kapan pun Anda siap"]
						}),
						/* @__PURE__ */ jsxs("h2", {
							className: "cf-h2",
							children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("a", {
									...
									href: "#",
									children: ["Pesan Demo ", /* @__PURE__ */ jsx("i", { className: "bx bx-right-arrow-alt" })]
								}),
								/* @__PURE__ */ jsx("a", {
				...
				children: [/* @__PURE__ */ jsxs("span", { children: [
					...
					children: [
						/* @__PURE__ */ jsx("a", {
							href: "#",
							"aria-label": "Twitter",
							children: /* @__PURE__ */ jsx("i", { className: "bx bxl-twitter" })
						}),
						/* @__PURE__ */ jsx("a", {
							href: "#",
							"aria-label": "LinkedIn",
							children: /* @__PURE__ */ jsx("i", { className: "bx bxl-linkedin" })
						}),
						/* @__PURE__ */ jsx("a", {
							href: "#",
							"aria-label": "GitHub",
							children: /* @__PURE__ */ jsx("i", { className: "bx bxl-github" })
						}),
						/* @__PURE__ */ jsx("a", {
							href: "#",
							"aria-label": "YouTube",
							children: /* @__PURE__ */ jsx("i", { className: "bx bxl-youtube" })
						})
					]
				})]
			})]
...
function FloatingCTA() {
	return /* @__PURE__ */ jsxs("a", {
		className: "cf-fab",
		href: "#cta",
		children: [/* @__PURE__ */ jsx("i", { className: "bx bx-calendar-check" }), " Pesan Demo"]
	});
}
//#endregion
